...
- Index & Middle finger up → Selection/Eraser mode (Hover over toolbar to change colors)
...
2. Run the application to open the webcam interface.
3. Use your finger gestures to draw, erase, and select colors directly on the screen without using a mouse or keyboard.
