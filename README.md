...
Usage
Run the application to open the webcam interface. Use your finger gestures to draw, erase, and select colors directly on the screen without using a mouse or keyboard.
